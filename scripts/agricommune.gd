...
var building_collisions: Array = [
	...
	# Chicken coop: drawn at chicken_coop_pos (120, 90) with x-18 offset, so renders at x=102
	Rect2(102, 100, 52, 40),    # Chicken coop body (adjusted to match actual sprite position)
